            ...
            <div className="flex flex-col items-center justify-center mt-10 py-10 bg-gray-100 h-auto w-auto">
                ...
                <div className="flex flex-col items-center justify-center bg-white w-[50%] h-auto rounded-md">
                    ...
                    <div className="flex flex-col justify-center items-center pb-10">
                        <p className="text-[22px] py-5 text-green-500">PKR 99,00,000</p>
                        <Link href="/checkOut">
                            <button type="button" className="p-2 px-3 bg-blue-800 rounded text-[12px] text-white hover:bg-green-500">Make Payment</button>
                        </Link>
                    </div>
                </div>
            </div>
